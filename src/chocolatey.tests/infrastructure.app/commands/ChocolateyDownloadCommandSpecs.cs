...
namespace chocolatey.tests.infrastructure.app.commands
{
    ...
    public class ChocolateyDownloadCommandSpecs
    {
        public abstract class ChocolateyDownloadCommandSpecsBase : TinySpec
        {
            protected ChocolateyDownloadCommand command;
            ...
            public override void Context()
            {
                ...
                command = new ChocolateyDownloadCommand(packageService.Object);
            }
        }

        public class when_implementing_command_for : ChocolateyDownloadCommandSpecsBase
        {
        ...
        public class when_configurating_the_argument_parser : ChocolateyDownloadCommandSpecsBase
        {
        ...
        public class when_handling_additional_argument_parsing : ChocolateyDownloadCommandSpecsBase
        {
        ...
        public class when_handling_validation : ChocolateyDownloadCommandSpecsBase
        {
            public override void Because()
            {
            }
        ...
        public class when_noop_is_called : ChocolateyDownloadCommandSpecsBase
        {
            public override void Because()
            {
        ...
        public class when_run_is_called : ChocolateyDownloadCommandSpecsBase
        {
            public override void Because()
            {
